...
public class HttpSinkConfig implements Serializable {
    ...
    @FieldDoc(required = true, defaultValue = "", help = "request timeout nano seconds")
    private long timeoutNanoSeconds;

    @FieldDoc(required = true, defaultValue = "http", help = "scheme")
    private String scheme;

    @FieldDoc(required = true, defaultValue = "", help = "http host")
    private String httpHost;

    @FieldDoc(required = true, defaultValue = "", help = "http port")
    private int httpPort;

    @FieldDoc(required = true, defaultValue = "", help = "http uri")
